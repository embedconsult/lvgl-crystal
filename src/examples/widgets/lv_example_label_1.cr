...
#
# [Original C Source](https://docs.lvgl.io/9.4/examples/widgets/label/lv_example_label_1.html)
#
# ![ExampleWidgetLabel1](images/lv_example_label_1.png)
@[Lvgl::ExampleMetadata(section: "Widgets", title: "Label alignment with simple styles", image_path: "images/lv_example_label_1.png", source_url: "https://docs.lvgl.io/9.4/examples/widgets/label/lv_example_label_1.html")]
